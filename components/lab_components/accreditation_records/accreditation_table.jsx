...
import { deleteAccreditationRecord } from '@/app/lib/lab_actions';
...
export default function AccreditationRecordsTable(props){
    ...
    const [deleteFormState, deleteFormAction] = useActionState(deleteAccreditationRecord, {error:null})
    ...
    useEffect(() => {
      if(Object.keys(deleteFormState).includes("success")){
          ...
          if(deleteFormState.error === null){
              setSnackBarMessage(`Accreditation record successfully removed.`)
              ...
              <div className={styles.sub_modal_container}>
                  ...
                  <div className={styles.form_container}>
                    <div className={styles.form_header}>
                        <h2>Delete accreditation record</h2>
                        <p>Are you sure you want to delete this accreditation record?</p>
                        <hr />
                    </div>
